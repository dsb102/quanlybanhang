...
public class Payment extends javax.swing.JFrame {
    ...
    public Payment(ListOrder order) {
        this.order = order;
        initComponents();
...
//    }
    ...
    public JTable getTblListProduct() {
        return tblListProduct;
    }

    public void setTblListProduct(DefaultTableModel model) {
        this.tblListProduct.setModel(model);
    }

    public JTextField getTxfBillCustname() {
        return txfBillCustname;
    }

    public void setTxfBillCustname(String txfBillCustname) {
        this.txfBillCustname.setText(txfBillCustname);
    }

    public JTextField getTxfBillEmployeeName() {
        return txfBillEmployeeName;
    }

    public void setTxfBillEmployeeName(String txfBillEmployeeName) {
        this.txfBillEmployeeName.setText(txfBillEmployeeName);
    }

    public JTextField getTxfBillOrderDate() {
        return txfBillOrderDate;
    }

    public void setTxfBillOrderDate(String txfBillOrderDate) {
        this.txfBillOrderDate.setText(txfBillOrderDate);
    }

    public JTextField getTxfBillPhoneNum() {
        return txfBillPhoneNum;
    }

    public void setTxfBillPhoneNum(String txfBillPhoneNum) {
        this.txfBillPhoneNum.setText(txfBillPhoneNum);
    }

    public JTextField getTxfBillTotalPrice() {
        return txfBillTotalPrice;
    }

    public void setTxfBillTotalPrice(String txfBillTotalPrice) {
        this.txfBillTotalPrice.setText(txfBillTotalPrice);
    }

    public JTextField getTxfPayment() {
        return txfPayment;
    }

    public void setTxfPayment(String txfPayment) {
        this.txfPayment.setText(txfPayment);
    }
